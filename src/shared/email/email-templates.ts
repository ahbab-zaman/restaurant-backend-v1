...
export const getVerificationOtpEmailTemplate = (user: { name?: string; email: string }, otp: string) => {
  const html = `
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
    ...
    .otp { display: inline-block; padding: 14px 24px; border: 1px solid #000; border-radius: 6px; font-size: 28px; letter-spacing: 8px; margin: 20px 0; }
    .footer { font-size: 12px; color: #000; text-align: center; margin-top: 20px; border-top: 1px solid #000; padding-top: 20px; }
  </style>
</head>
<body>
